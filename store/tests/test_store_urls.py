...
class StoreURLsTest(TestCase):
    ...
    def test_store_product_categories_url_is_correct(self):
        product_url = reverse('store:category', kwargs={'category_id': 1})
        self.assertEqual(product_url, '/products/category/1/')
